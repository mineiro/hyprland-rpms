...
%description
Wraps standalone Wayland compositors into a set of systemd user units on the
fly. This provides robust session management including environment, XDG
autostart support, bi-directional binding with login session, and clean
shutdown.
